...
<template>
  ...
  <div style="margin-top:20px">
    ...
    <h2 class="display-4 " align="center">Sponsor Register Portal</h2>
  </div>
  <div class="registerform">
    ...
    <div class="form-group" align="center">
        <button type="submit" id="submission" class="btn"  align="center" @click.prevent="validateform">Sign Up 
          <span class="mdi mdi-office-building-plus"></span> </button>
    </div>
</form>
  </div>
        ...
        axios
                ...
                .then((response) => {
                    ...
                    if(response.status == 200){
                        ...
                        this.addinfo = null,
                        this.profpic = false,
                        alert('Registration Successfull! Welcome to CreativeMerge');
                        this.$router.push('/login');
                    }
                    else{
                        console.log("Registration Failed");
                        alert('Registration Failed! Reason: ' + response.data.message +' Please try again');
                    }
                })
                .catch((error) => {
                    console.log(error);
