...
<template>
  ...
  <div style="margin-top:20px">
    ...
    <h2 class="display-4 " align="center">Influencer Register Portal</h2>
  </div>
  <div class="registerform">
    ...
    <div class="form-group"  id="submitting">
        <button type="submit" id="submission" class="btn"   @click.prevent="submitForm">Sign Up 
            <span class="mdi mdi-account-plus"></span></button>
    </div>
</form>
</div>
