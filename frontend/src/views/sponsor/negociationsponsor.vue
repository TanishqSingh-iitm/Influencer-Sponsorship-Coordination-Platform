...
export default {
  ...
  methods: {
    getmessages(){
      axios
          .get('http://localhost:5000/sponsor/'+this.jobid+'/chats',{
    ...
    sendmessage(){
      axios
          .post('http://localhost:5000/sponsor/'+this.jobid+'/chats',{
    ...
    approverequest(){
            axios
            .put('http://localhost:5000/adrequest/'+this.jobid+'/approve',{},
                 {headers: {Authorization: this.auth}})
            .then((response) => {
    ...
    rejectrequest(){
            axios
            .put('http://localhost:5000/adrequest/'+this.jobid+'/reject',{},
                 {headers: {Authorization: this.auth}})
            .then((response) => {
                console.log(response);
