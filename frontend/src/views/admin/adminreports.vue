        ...
        <div class="reports" v-for="(Data, index) in data" :key="data.id">
            <div class="report">
                ...
                <div class="reportcontent">
                    <div class="reportcontentheader">
                        <h4>Issue:</h4>
                        <h5 style="text-align: justify;">{{Data.issue}}</h5>
                    </div>
                </div>
                <div class="reportcontent">
                    <div class="reportcontentheader">
...
export default {
  ...
  methods: {
    getdata() {
      axios.get('http://localhost:5000/admin/'+ this.users_id+'/reports', {
        headers: {
