...
<div >
    ...
    <div class="container">
    <p class="f-3" style="font-size:23px;">Are you sure you want to delete this advertisement campaign <b>{{this.campaigntitle}}</b>?</p>
    ...
    export default {
        ...
        methods: {
            deleteaccount(){
                axios
                .post(
                        `http://localhost:5000/sponsor/campaign/${this.campaignid}`,
                            { pass: this.password },
                        {
                             headers: {
            ...
            getdetails(){
                ...
                .then((response) => {
                    ...
                    if(response.status == 200){
                        ...
                        alert('Campaign Fetch Failed! Reason: ' + response.data.message +' Please try again');
                    }
                })
                .catch((error) => {
                    console.log(error);
