...
<template>
  ...
  <div style="margin-top:20px">
    <h2 class="display-4 " align="center">Campaign Creation Portal</h2>
  </div>
  <div class="registerform">
    ...
    <div class="form-group">
        ...
        <input type="text" name="industry" placeholder="Type Campaign Related Industry" required class="form-control" style="border-radius: 60px;" v-model="industry">
    </div><br>
    <div class="form-group">
        <label for="niche" class="form-label" style="font-size: 20px;"><span class="mdi mdi-play-network"></span> Campaign Related Niche</label>
        <input type="text" name="niche" placeholder="Type Campaign Related Niche" required class="form-control" style="border-radius: 60px;" v-model="niche">
    </div><br>
    <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    createcampaign(){
        axios
                .post('http://localhost:5000/sponsor/campaign', {
                    name: this.name,
                ...
                .then((response) => {
                    ...
                    if(response.status == 200){
                        ...
                        alert('Campaign Creation Failed! Reason: ' + response.data.message +' Please try again');
                    }
                })
                .catch((error) => {
                    console.log(error);
