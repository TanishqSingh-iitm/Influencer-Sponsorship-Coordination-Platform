...
<div >
    ...
    <div class="container">
    <p class="f-3" style="font-size:23px;">Are you sure you want to delete your Influencer Account with username <b>{{this.username}}</b>?</p>
    ...
    export default {
        ...
        methods: {
            deleteaccount(){
                axios
                .post(
                        `http://localhost:5000/influencerprofile/deleteaccount/${this.user_id}`,
                            { pass: this.password },
                        {
                             headers: {
